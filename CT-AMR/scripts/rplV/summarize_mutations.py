...
# --- USER INPUT ---
alignment_file = "rplV_aligned.fasta"  # aligned protein FASTA file
reference_id = "C_ref_00548"           # replace with your reference sequence ID
# ------------------
...
for record in alignment:
    ...
    for pos, (ref_aa, sample_aa) in enumerate(zip(ref_seq, sample_seq), start=1):
        real_pos = pos + 1  # Shift position by +1
